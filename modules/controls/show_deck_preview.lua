Handy.show_deck_preview = {
	...
	get_is_hold = function()
		if Handy.is_mod_active() and Handy.controller.is_module_enabled(Handy.cc.regular_keybinds) then
			return G.STAGE == G.STAGES.RUN and Handy.controller.is_module_key_down(Handy.cc.show_deck_preview, true)
		else
