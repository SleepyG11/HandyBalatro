Handy.insta_actions = {
	...
	get_actions = function(ctx)
		return {
			buy_n_sell = Handy.controls_v2.is_module_enabled(Handy.cc.insta_actions_buy_n_sell)
				and Handy.controls_v2.is_module_keys_hold(Handy.cc.insta_actions_buy_n_sell, { ctx = ctx }),
			buy_or_sell = Handy.controls_v2.is_module_enabled(Handy.cc.insta_actions_buy_or_sell)
				and Handy.controls_v2.is_module_keys_hold(Handy.cc.insta_actions_buy_or_sell, { ctx = ctx }),
			use = Handy.controls_v2.is_module_enabled(Handy.cc.insta_actions_use)
				and Handy.controls_v2.is_module_keys_hold(Handy.cc.insta_actions_use, { ctx = ctx }),
		}
	end,
	get_target_card = function(item, context)
		...
		elseif context.input then
			target_card = G.CONTROLLER.dragging.target or Handy.controller_v2.card.get_context().hovered_current
		end
	...
	can_execute = function(item, args)
		...
		if
			not Handy.controls_v2.can_execute_control(item, {
				no_keybinds = true,
