Handy.move_highlight = {
	...
	get_actions = function()
		local dx
		local is_hold, hold_duration = Handy.controls_v2.is_module_keys_hold(Handy.cc.move_highlight_dx_one_left)
		if is_hold then
			dx = Handy.move_highlight.dx.one_left
		else
			is_hold, hold_duration = Handy.controls_v2.is_module_keys_hold(Handy.cc.move_highlight_dx_one_right)
			if is_hold then
