Handy.load_file("src/controls_v2/controls/regular_keybinds/logic.lua")
Handy.load_file("src/controls_v2/controls/regular_keybinds/hooks.lua")

---

Handy.controls_v2.register("regular_keybinds_play", {
	...
	can_execute = function(self, args)
		return not Handy.regular_keybinds.play_blocker
			...
			and Handy.controls_v2.can_execute_control(self, args)
...
Handy.controls_v2.register("regular_keybinds_discard", {
	get_module = function(self)
...
Handy.controls_v2.register("regular_keybinds_change_sort_rank", {
	get_module = function(self)
	...
	can_execute = function(self, args)
		return G.STATE == G.STATES.SELECTING_HAND and Handy.controls_v2.can_execute_control(self, args)
	end,
...
Handy.controls_v2.register("regular_keybinds_change_sort_suit", {
	get_module = function(self)
...
Handy.controls_v2.register("regular_keybinds_toggle_sort", {
	get_module = function(self)
...
Handy.controls_v2.register("regular_keybinds_reroll_shop", {
	get_module = function(self)
...
Handy.controls_v2.register("regular_keybinds_leave_shop", {
	get_module = function(self)
...
Handy.controls_v2.register("regular_keybinds_skip_blind", {
	get_module = function(self)
...
Handy.controls_v2.register("regular_keybinds_select_blind", {
	get_module = function(self)
...
Handy.controls_v2.register("regular_keybinds_reroll_boss", {
	get_module = function(self)
...
Handy.controls_v2.register("regular_keybinds_run_info", {
	get_module = function(self)
...
Handy.controls_v2.register("regular_keybinds_run_info_binds", {
	get_module = function(self)
...
Handy.controls_v2.register("regular_keybinds_view_deck", {
	get_module = function(self)
...
Handy.controls_v2.register("regular_keybinds_view_lobby_info", {
	get_module = function(self)
...
Handy.controls_v2.register("regular_keybinds_mod_settings", {
	get_module = function()
	...
	can_execute = function(self, args)
		return not G.OVERLAY_MENU and Handy.controls_v2.can_execute_control(self, args)
	end,
	execute = function()
...
Handy.controls_v2.register("regular_keybinds_restart", {
	get_module = function()
	...
	can_execute = function(self, args)
		...
		then
			...
			local is_hold, hold_duration = Handy.controls_v2.is_module_keys_hold(Handy.cc.regular_keybinds_restart)
...
Handy.controls_v2.register("regular_keybinds_quick_restart", {
	get_module = function()
...
Handy.controls_v2.register("regular_keybinds_save_run", {
	get_module = function()
...
Handy.controls_v2.register("regular_keybinds_reload_run", {
	get_module = function()
	...
	can_execute = function(self, args)
		return not Handy.regular_keybinds.reload_run_blocker and Handy.controls_v2.can_execute_control(self, args)
	end,
	execute = function()
...
Handy.controls_v2.register("regular_keybinds_start_fantoms_preview", {
	get_module = function()
...
Handy.controls_v2.register("regular_keybinds_skip_booster", {
	get_module = function()
...
Handy.controls_v2.register("regular_keybinds_cash_out", {
	get_module = function()
...
Handy.controls_v2.register("regular_keybinds_not_just_yet_interaction", {
	get_module = function()
...
Handy.controls_v2.register("regular_keybinds_show_deck_preview", {
	get_module = function(self)
