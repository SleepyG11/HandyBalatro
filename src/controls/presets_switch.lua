...
function Handy.presets_switch.get_next_preset_index(load_index)
...
function Handy.presets_switch.load_index(index)
...
function Handy.presets_switch.show_notif(switch_result)
	local text = ""

	if switch_result.loaded then
		text = Handy.L.variable("Handy_preset_loaded", { switch_result.load_index, switch_result.preset.name or "" })
	...
	elseif switch_result.preset and not switch_result.enabled then
		text = Handy.L.variable("Handy_preset_disabled", { switch_result.load_index, switch_result.preset.name or "" })
